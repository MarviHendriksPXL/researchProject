    ...
    <div class='container-main'>
      <main class="main-content">
        <img class="main-image"
          ...
          alt="" loading="lazy" />
        <p id="title">PDF</p>
        <input class='fileInput' name='fileInput' id='fileInput' v-if="isAdmin" type='file' @change='onFileChange' />
...
export default {
  ...
  methods: {
    ...
    uploadFile: async function () {
      ...
      try {
        await this.global.PDFUpload(this.mareId, formData)
    ...
    readFile: async function () {
      await this.global.getPDF(this.mareId)
