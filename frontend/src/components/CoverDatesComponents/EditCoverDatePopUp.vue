<template>
    ...
    <div class="pop-up">
        <h1>Verander dekdatum</h1>
        <input id="dateInput" type="date" v-model="edit">

        <div class="buttons">
            <button @click="editEntry()" class="addButton">Opslaan</button>
...
export default {
  ...
  methods: {
    async editEntry () {
      try {
        await this.global.updateCoverdateEntry(this.entryId, this.edit)
        this.closePopUp()
      } catch (error) {
